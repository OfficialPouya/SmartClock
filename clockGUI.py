...
def time_print(day,day_num,postfix,month,clock,ampm):
	...
	ampm=ampm.split(',')
	if(ampm[0]=="AM"):
		return (clock[0],':',clock[1],"AM")
	else:
		return (clock[0],':',clock[1],"PM")
...
app = App(title="Smart Clock", bg = "black",layout="auto", width=750, height=750)
time_text = Text(app, text=time_print(day,day_num,postfix,month,clock,ampm), size=40, font="Times New Roman", color="#FA8072" )
